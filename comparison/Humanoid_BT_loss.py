...
if __name__ == '__main__':
    ...
    while round_cnt < NUM_ROUNDS:
        ...
        for i in range(500):
            ...
            bt_loss = - (1.0*history_label_tensor * torch.log(BT_prob(reward_0,reward_1,alpha=3.0))  + (1-1.0*history_label_tensor) * torch.log(BT_prob(reward_1,reward_0,alpha=3.0)))
