...
def eval_ensemble(mpc_module,ens_model):
    ...
    obs_seq, act_seq = mpc_module.generate_traj_walker(model_fn,render=True,init_pos=None, init_vel=None,noiselevel=0.0,lam_mppi=0.01)
...
if __name__ == '__main__':
    ...
    ens = EnsembleModels(RewardFCModel,{'input_dim':23,"hidden_dim":256,"num_hidden_layers":3},3,device)
