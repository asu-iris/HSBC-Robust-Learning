...
if __name__ == '__main__':
    ...
    while round_cnt < NUM_ROUNDS:
        ...
        for i in range(500):
            ...
            reward_0 = reward_pred[...,0]-1 #-1 is for numerical stability and keep reward < 0
            reward_1 = reward_pred[...,1]-1

            bt_loss = - (1.0*history_label_tensor * torch.log(BT_prob(reward_0,reward_1,alpha=10.0))  + (1-1.0*history_label_tensor) * torch.log(BT_prob(reward_1,reward_0,alpha=10.0)))
