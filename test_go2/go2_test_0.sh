...
python test_go2/Go2_Robust_Align_free.py  --dir Data/Go2_big/RA/error_0/run_0 --device 0 --err 0 --rounds 101 --opt Adam --dense True --model_num 16 --freq 5
python test_go2/Go2_Robust_Align_free.py  --dir Data/Go2_big/RA/error_0/run_1 --device 0 --err 0 --rounds 101 --opt Adam --dense True --model_num 16 --freq 5
