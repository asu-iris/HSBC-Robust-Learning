...
import sys,os
from iris_env.gym_like.humanoid_standup.humanoidstandup import HumanoidStandup, VmapWrapper, RolloutVmapWrapper



class Humanoid_MPC(object):
    def __init__(self, Horizon=40, rollout_length=100, planner_num=256, sigma=0.4) -> None:
        ...
        self.env = HumanoidStandup(frame_skip=3,timestep=0.01)
    ...
    def generate_traj_humanoid(self,torch_model,render = False, init_pos = None, init_vel = None, noiselevel = 0.0, lam_mppi = 1.0, filename = 'simulation_output.html'):
        #planner:
        ...
        if init_vel is not None:
            ...
            init_qvel_arr = 0.01*np.random.uniform(-1,1,size = 23)
        ...
        for t in range(self.rollout_length):
            ...
            if t%10 == 9:
                print('t',t,'z',obs[0],'v',torso_vel,'wz',torso_w)
            #print('action',action)
            env_obss.append(obs)
