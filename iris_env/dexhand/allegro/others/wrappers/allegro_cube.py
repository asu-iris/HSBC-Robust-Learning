...
class AllegroCubeEnvMJX:

    def __init__(self, param):

        # model path
        self.model_path = 'envs/allegro/models/allegro_cube.xml'
        ...
        # system dimensions:
        self.n_robot_qpos=16
        self.n_robot_qvel=16
        self.n_qpos = 23
        self.n_qvel = 22
        self.n_action = 16

        # low-level control loop
        self.frame_skip = int(50)
    ...
    def step(self, action_batch: jax.Array):
        ...
        curr_jpos_batch = self.mjx_data_batch.qpos[:,0:self.n_robot_qpos]
