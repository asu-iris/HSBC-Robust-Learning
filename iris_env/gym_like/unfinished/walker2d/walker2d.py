...
mpc_dyn_num = 512
mpc_dyn = envs.create(env_name='walker2d', batch_size=mpc_dyn_num,
                      episode_length=None,
                      auto_reset=False,
                      backend='mjx')
...
mpc_dyn_state2 = mpc_dyn.reset(rng=jnp.array(random.PRNGKey(2)))


env = envs.create(env_name='walker2d',
                  episode_length=None,
                  auto_reset=False,
                  backend='mjx')
