...
for t in range(env_rollout_length):
    ...
    planner_actions = 5*(jax.random.uniform(key, shape=(planner_num, planner_horizon, planner.action_size))-0.5)
    ...
    # final state
    # planner_sum_rewards=planner_sum_rewards+0.02*planner_state.metrics['reward_forward']
